...
# Example:
make_shards("/cs/data/people/hnam16/.stable_worldmodel/pusht_expert_train_video/videos", "train", "/cs/data/people/hnam16/data/pusht_wds_mp4/train", maxcount=512)
make_shards("//cs/data/people/hnam16/.stable_worldmodel/pusht_expert_val_video/videos", "val", "/cs/data/people/hnam16/data/pusht_wds_mp4/validation", maxcount=512)
