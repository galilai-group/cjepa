"""
Extract slot features from CLEVRER videos using VideoWM and save to disk for fast loading.
...
from visualization.model import load_video_model_from_checkpoint
...
def extract_and_save_slot_features(cfg):
    ...
    world_model = load_video_model_from_checkpoint(cfg)
