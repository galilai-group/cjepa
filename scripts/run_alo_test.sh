...
python slotformer/clevrer_vqa/test_clevrer_vqa.py \
  ...
  --weight '/cs/data/people/hnam16/aloe_checkpoint/aloe_clevrer_params_20251230_031853/clevrer_slots_step=100000_weight01_lr5e-4_clevrer/epoch/model_400_salr5e-4_w01_aloelr_1e-3.pth'
