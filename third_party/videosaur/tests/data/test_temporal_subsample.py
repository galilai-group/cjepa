...
from third_party.videosaur.videosaur.data.transforms import TemporalSubsample
...
def test_temporal_subsample_pipeline_helper():
    from third_party.videosaur.videosaur.data.pipelines import temporal_subsample_keys
